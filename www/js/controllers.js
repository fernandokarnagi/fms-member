...
.controller('WelcomeCtrl', function($scope, $state, $window, $stateParams, 
		TaskService, $cordovaDialogs, $cordovaCamera) {
	
})

.controller('InspectionListCtrl', function($scope, $state, $window, $stateParams, 
		TaskService, $cordovaDialogs, $cordovaCamera) {
	...
	$scope.viewDetails = function(task) {
		...
		$state.go('tab.inspectiondetails', {'task' : taskJson});
			  
	}
})

.controller('InspectionDetailsCtrl', function($scope, $state, $window, $stateParams, 
...
.controller('CleaningPerformanceCtrl', function($scope, $state, $window, $stateParams, 
		TaskService, $cordovaDialogs, $cordovaCamera) {
	...
	$scope.viewDetails = function(task) {
		...
		console.log(task);
		var taskJson = angular.toJson(task);
		$state.go('tab.cleaningperformancedetails', {'task' : taskJson});
			  
	}
})

.controller('CleaningPerformanceDetailsCtrl', function($scope, $state, $window, $stateParams, 
		TaskService, $cordovaDialogs, $cordovaCamera, $cordovaActionSheet) {
